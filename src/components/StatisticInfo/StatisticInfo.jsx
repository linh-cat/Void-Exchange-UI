...
const StatisticInfo = () => {
  return (
    <section className="container mx-auto statistic-container text-center flex flex-col gap-10 mt-10">
      ...
      <div className="statistic-bottom flex flex-col lg:grid lg:grid-flow-col lg:grid-cols-3 border border-slate-500 rounded">
